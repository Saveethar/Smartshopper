package com.retail.shopper.SmartShopperLogin.util;
...
public class Utils {
	...
	/**
	 * This method is used to get the root cause of the error - Class:Method:Line#
	 * 
	 * @param t
	 *            - Throwable exception object
	 * @return String - Cause of the exception
	 */
	public String getCause(Throwable t) {
		StackTraceElement[] ste = t.getStackTrace();

		return ste[0].getClassName() + ":" + ste[0].getMethodName() + ":"
				+ ste[0].getLineNumber() + ":" + t.getCause();
	}
