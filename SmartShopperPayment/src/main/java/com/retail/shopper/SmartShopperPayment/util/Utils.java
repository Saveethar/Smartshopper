package com.retail.shopper.SmartShopperPayment.util;
...
import com.retail.shopper.SmartShopperPayment.constants.PaymentConstants;
...
public class Utils {
	...
	public void sendEmail(String subject, String message) {
		...
		properties.setProperty(PaymentConstants.MAIL_HOST_STRING.value(), PaymentConstants.HOST.value());
		Session session = Session.getDefaultInstance(properties);
		try {
			MimeMessage mimeMessage = new MimeMessage(session);

			mimeMessage.setFrom(new InternetAddress(PaymentConstants.FROM.value()));
			mimeMessage.addRecipient(Message.RecipientType.TO, new InternetAddress(PaymentConstants.TO.value()));
